...
export class OpenMetadataMcpLineageProvider implements LineageProvider {
...
// Backward-compatible export used by older imports/tests.
export { OpenMetadataMcpLineageProvider as McpLineageProvider };
